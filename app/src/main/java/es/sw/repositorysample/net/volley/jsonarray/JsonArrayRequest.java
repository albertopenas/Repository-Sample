 ...
 */
public abstract class JsonArrayRequest<T,J> extends Request<ServerResponse<T, J>>{
     ...
     * @param errorListener
     */
    public JsonArrayRequest(int method, String url, Map<String, String> headers, ResponseListener<T, J> responseListener, Response.ErrorListener errorListener) {
     ...
     * @param errorListener
     */
    public JsonArrayRequest(int method, String url, ResponseListener<T, J> responseListener, Response.ErrorListener errorListener) {
        super(method, url, errorListener);
        headers = null;
        this.responseListener = responseListener;
    }
    ...
    protected Response<ServerResponse<T, J>> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            if (BuildConfig.DEBUG){
                Log.e(TAG, jsonArray.toString(8));
            }
            ServerResponse<T, J> object = parse(jsonArray);
     ...
     * @return
     */
    protected abstract ServerResponse<T, J> parse(JSONArray jsonArray);
